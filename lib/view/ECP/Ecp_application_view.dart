                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: custom_text(
                          text: provider.empid?.toString() ?? 'Loading...',
                      ...
                      Container(
                        ...
                        child: custom_text(
                          text: provider.empname?.toString() ?? 'Loading...',
                          fontSize: screenWidth * 0.04,
                        ),
                      ),
                      SizedBox(height: screenHeight * 0.02),
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              if (provider.formKey.currentState?.validate() ??
                                ...
                                final arrivaltime =
                                    provider.selectedarrivalTime.toString();
                                final leavingtime =
                                    provider.selectedLeavingTime.toString();
                                ...
                                ScaffoldMessenger.of(context)
                                  ...
                                  content: Container(
                                    ...
                                    child: const Center(
                                      child: custom_text(
                                        text: 'Check-in request submitted!',
                                        color: Colors.white,
                                      ),
                                    ),
                                  ),
